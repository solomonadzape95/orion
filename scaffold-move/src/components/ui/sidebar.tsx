...
const sidebarLinks = [
  ...
  { name: "Code Analysis", href: "/dashboard/analysis", icon: Code2 },
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "fixed h-full border-r border-sidebar-border bg-sidebar",
        "w-64 lg:w-16 hover:lg:w-64 transition-all duration-300",
